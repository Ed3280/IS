    ...
    g.error = {
        ...
        if (d && 0 != d.length) {
            ...
            for (var g = 0; g < d.length; g++) {
                ...
                0 == k && (k = h.lastIndexOf("http://responsiweb.com/") + 1), h = h.substr(k), 0 == i && (i = /\.(jpe?g|png|gif|svg|bmp|tiff?)$/i.test(h) ? "image" : /\.(mpe?g|flv|mov|avi|swf|mp4|mkv|webm|wmv|3gp)$/i.test(h) ? "video" : /\.(mp3|ogg|wav|wma|amr|aac)$/i.test(h) ? "audio" : "file");
                var l = {
                    file: "fa fa-file",
